...
# just learn how to send the emails with adding a pic and wierd ascii characters in py or html
msg = """Plan:
...
Create a web page using HTML, CSS, and JavaScript to collect user input, including the email address. 
